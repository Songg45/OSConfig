...
$results += Test-ProgramCheck -Name 'Spotify' -DisplayNamePattern 'Spotify*' -Paths @("$env:APPDATA\Spotify\Spotify.exe", "$env:LOCALAPPDATA\Microsoft\WindowsApps\Spotify.exe")
